/*global angular*/
/*global dashjs*/
/*global OrangeDownloadRatioRule, OrangeDroppedFramesRule, OrangeInsufficientBufferRule, OrangeLimitSwitchRule, OrangeAbandonRequestsRule*/
/*global ControlBar*/
/*exported legendLabelClickHandler*/
...
app.controller('DashController', function ($scope, sources, contributors) {
    ...
    $scope.player.addABRCustomRule('qualitySwitchRules', 'OrangeDownloadRatioRule', OrangeDownloadRatioRule);
    $scope.player.addABRCustomRule('qualitySwitchRules', 'OrangeDroppedFramesRule', OrangeDroppedFramesRule);
    $scope.player.addABRCustomRule('qualitySwitchRules', 'OrangeInsufficientBufferRule', OrangeInsufficientBufferRule);
    $scope.player.addABRCustomRule('qualitySwitchRules', 'OrangeLimitSwitchRule', OrangeLimitSwitchRule);
    $scope.player.addABRCustomRule('abandonFragmentRules', 'OrangeAbandonRequestsRule', OrangeAbandonRequestsRule);
